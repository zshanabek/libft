...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/04/11 17:06:38 by vradchen          #+#    #+#             */
/*   Updated: 2018/04/11 17:06:38 by vradchen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_string_part2(t_style *style, wchar_t *str)
{
	int		len;
	int		i;
	...
	else
	{
		if (style->acc > 6)
			style->acc = 6;
		style->width = style->width - style->acc;
	}
}
